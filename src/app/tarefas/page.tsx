...
const mockTasks: Task[] = [
  {
    id: 1,
    title: "Criar Homepage",
    description: "Create wireframes e protótipos",
    completed: false,
  },
  {
    id: 2,
    title: "Organizar banco de dados",
  ...
  },
  {
    id: 3,
    title: "Integrar API",
    description: "Conectar frontend ao backend",
    completed: false,
  },
  {
    id: 4,
    title: "Implementar autenticação",
    description: "Configurar login e logout",
    completed: false,
  },
  {
    id: 5,
  ...
  },
  {
    id: 6,
    title: "pegar onibus",
    description: "as 8 horas",
    completed: true,
  },
  {
    id: 7,
    title: "lavar cabelo",
    description: "com sabao",
    completed: false,
  },
  {
    id: 8,
    title: "tomar banho",
    description: "de manhã",
    completed: true,
  },
  {
    id: 9,
    title: "escovar dentes",
    description: "com colgate",
    completed: false,
  },
  {
    id: 10,
  ...
  },
  {
    ...
    description: "Code review do projeto",
    completed: true,
  },
  {
    id: 14,
    title: "Documentar API",
    description: "Criar documentação com Swagger",
    completed: false,
  },
  {
    id: 15,
    title: "Deploy em produção",
    description: "Fazer release da v1.0",
    completed: false,
  },
  {
    id: 16,
  ...
  },
  {
    ...
    description: "Melhorar velocidade da página",
    completed: false,
  },
  {
    id: 18,
    title: "Implementar temas",
  ...
  },
  {
    ...
    description: "Toast e push notifications",
    completed: false,
  },
  {
    id: 20,
...
export default function TarefasPage() {
  ...
  const endIndex = startIndex + TAREFAS_POR_PAGE;
  const paginatedTasks = mockTasks.slice(startIndex, endIndex);
  const totalPages = Math.ceil(mockTasks.length / TAREFAS_POR_PAGE);
